...
var questionList = ["Aquarius":[(question(question: "What is the shape of the Earth?", options: ["Round","Square","Flat",""], answer:1),1),
                    ...
                    "Aquila":[(question(question: "What is the Earth's crust?", options: ["The Earth's core made of chocolate","The layer of floating clouds in the sky","The outermost layer of the Earth's surface,  like the skin on an apple",""], answer:3),1),
                              ...
                              (question(question: " What is the largest ocean on Earth?", options: [" Atlantic Ocean"," Indian Ocean "," Arctic Ocean",""], answer:2),9),
                              (question(question: " Which ocean is located between North America and Europe?", options: [" Indian Ocean"," Atlantic Ocean "," Southern Ocean",""], answer:2),9),
                              (question(question: " True or False: The oceans cover about 70% of Earth's surface.", options: [" True"," False"," ",""], answer:1),9),
                              (question(question: " Which ocean is known for being cold and has lots of icebergs?", options: [" Atlantic Ocean"," Southern Ocean "," Pacific Ocean",""], answer:2),9),
                              (question(question: " Which ocean is home to the Great Barrier Reef one of the largest coral reef systems in the world?", options: [" Indian Ocean"," Coral Sea "," Arctic Ocean",""], answer:2),9),
                    ...
                    "Ophiuchus":[(question(question: "What is the name of the theory that explains how the universe began?", options: ["The Big Freeze theory","The Multiverse theory","The Big Bang theory ",""], answer:3),1),
                                 (question(question: "How did the universe start according to the Big Bang theory?", options: ["The universe was always here","The universe formed from a giant explosion of stars","The universe started from an incredibly hot and dense point and has been expanding ever since ",""], answer:3),1),
                                 (question(question: "How old is the universe according to scientists?", options: ["100000 years","13.8 billion years ","500 million years",""], answer:3),1),
                                 (question(question: "What is the Cosmic Microwave Background (CMB)?", options: ["Leftover food in space","Faint microwaves from distant galaxies","The leftover heat from the Big Bang detectable as faint microwaves throughout the universe ",""], answer:3),1),
                                 (question(question: "Who first proposed the Big Bang theory?", options: ["Albert Einstein","Georges Lemaître ","Isaac Newton",""], answer:2),1),
                                 (question(question: "What evidence supports the Big Bang theory?", options: ["The universe is shrinking","The moon's gravity","Evidence includes the expansion of the universe  the redshift of distant galaxies  and the discovery of the Cosmic Microwave Background ",""], answer:2),2),
                                 (question(question: "What is the role of gravity in the formation of the universe?", options: ["Gravity pushes everything apart","Gravity helps bring matter together forming stars  galaxies  and other structures ","Gravity makes objects float in space",""], answer:3),2),
                                 (question(question: "What is a singularity?", options: ["A popular dance move","A point where all matter and energy in the universe is concentrated ","A type of black hole",""], answer:2),2),
                                 (question(question: "What is inflation theory?", options: ["The theory that money will never lose its value","The theory that the universe expands and contracts like a balloon","The theory that the universe expanded rapidly just after the Big Bang ",""], answer:3),2),
                                 (question(question: "What is dark matter?", options: ["Matter that doesn't cast a shadow","A type of invisible light","A type of matter that does not emit or interact with light but can be detected through its gravitational effects on visible matter ",""], answer:3),2),
                                 (question(question: "What is dark energy?", options: ["The energy used by supervillains","A mysterious force causing the universe to expand at an accelerating rate ","The energy stored in black holes",""], answer:2),3),
                                 (question(question: "What is a black hole?", options: ["A hole in space where everything disappears","A region of space where gravity is weak","A region of space where gravity is so strong that nothing not even light  can escape from it ",""], answer:3),3),
                                 (question(question: "How are black holes formed?", options: ["By eating too much space food","From the remnants of massive stars that have collapsed under their own gravity ","They are created by aliens",""], answer:2),3),
                                 (question(question: "What is the Hubble Space Telescope?", options: ["A giant space magnifying glass","A powerful telescope in space that observes distant galaxies and the universe ","A space station for astronauts",""], answer:2),3),
                                 (question(question: "What is a supernova?", options: ["A type of star that only shines in the daytime","A powerful explosion when two stars collide","A powerful explosion that occurs when a massive star reaches the end of its life ",""], answer:3),3),
                                 (question(question: "How do scientists study the early universe?", options: ["By building time machines","By observing the light from distant objects and analyzing the Cosmic Microwave Background ","By asking ancient aliens for information",""], answer:2),4),
                                 (question(question: "What is the multiverse theory?", options: ["The theory that there are many different flavors of ice cream in space","The theory that there may be many universes each with its own set of physical laws ","The theory that the universe is a giant video game",""], answer:2),4),
                                 (question(question: "What is the theory of relativity?", options: ["The theory that everything is relative  like whether broccoli tastes good or bad","The theory that time travel is possible","The theory that describes how gravity works and how objects move in space and time ",""], answer:3),4),
                                 (question(question: "How do scientists know what happened billions of years ago?", options: ["They have a time-traveling pet dinosaur","They can watch the past on a cosmic TV","They can study the light from distant objects such as galaxies to learn about the history of the universe ",""], answer:3),4),
                                 (question(question: "What is the role of atoms in the universe?", options: ["Atoms are tiny space aliens","Atoms make up everything in the universe and are essential for the formation of stars  planets and living organisms ","Atoms are a type of candy in space",""], answer:2),4),
                                 (question(question: "What is a galaxy?", options: ["A type of chocolate candy bar","A large collection of stars gas  and dust held together by gravity ","A giant space cloud",""], answer:2),5),
                                 (question(question: "What is the Milky Way?", options: ["A candy bar in space","The galaxy in which our solar system is located ","A path made of milk in space",""], answer:2),5),
                                 (question(question: "What is the shape of the universe?", options: ["Square","Mostly flat ","Round",""], answer:2),5),
                                 (question(question: "What is a quasar?", options: ["A type of star that only shines in the daytime","An extremely bright and distant object powered by a supermassive black hole at its center ","A type of alien spaceship",""], answer:2),5),
                                 (question(question: "What is the difference between a planet and a star?", options: ["Planets are made of cheese  and stars are made of candy","Planets are small and stars are big and shiny ","Planets are stars that forgot how to shine",""], answer:2),5),
                                 (question(question: "What is the theory of the Big Crunch?", options: ["The theory that the universe is constantly munching on snacks","The theory that the universe could eventually stop expanding and start collapsing in on itself ","The theory that all the stars will collide and create a giant party",""], answer:2),6),
                                 (question(question: "What is a light-year?", options: ["The time it takes a light bulb to turn on","The distance that light travels in one day","The distance that light travels in one year which is about 5.88 trillion miles (9.46 trillion kilometers) ",""], answer:3),6),
                                 (question(question: "What is the source of energy for stars?", options: ["Magic","Nuclear fusion  where hydrogen atoms combine to form helium and release a tremendous amount of energy ","Solar panels in space",""], answer:2),6),
                                 (question(question: "What is the Doppler effect?", options: ["A dance move performed by stars","The change in frequency or wavelength of waves such as light or sound due to the relative motion between the source and the observer ","A type of space candy",""], answer:2),6),
                                 (question(question: "What is the significance of the cosmic web?", options: ["The cosmic web is where space spiders live","The cosmic web is a network of filaments and voids that make up the large-scale structure of the universe connecting galaxies together ","The cosmic web is a giant space sweater",""], answer:2),6),
                                 (question(question: "What is a nebula?", options: ["A colorful cloud made of cotton candy","A cloud of gas and dust in space where new stars are born ","A type of alien spaceship",""], answer:2),7),
                                 (question(question: "How do stars die?", options: ["They run out of batteries","They explode like fireworks on the Fourth of July","Stars can die in different ways depending on their mass. Smaller stars like our Sun will eventually expand into a red giant and then shed their outer layers leaving behind a white dwarf. More massive stars can explode in a supernova and leave behind a neutron star or a black hole ",""], answer:3),7),
                                 (question(question: "What is the theory of the steady state?", options: ["The theory that the universe is always calm and peaceful","The theory that the universe has always existed in a constant state  without a beginning or an end ","The theory that everything in space is made of metal",""], answer:2),7),
                                 (question(question: "What is a pulsar?", options: ["A type of star that dances in space","A highly magnetized rotating neutron star that emits beams of electromagnetic radiation ","A type of alien spaceship",""], answer:2),7),
                                 (question(question: "What is a comet?", options: ["A type of candy in space","A small icy object that orbits the Sun and develops a glowing tail when it gets close to the Sun ","A type of space cloud",""], answer:2),7),
                                 (question(question: "What is the purpose of space probes?", options: ["To find lost socks in space","Space probes are robotic spacecraft sent to explore space and gather information about other planets moons  and other objects in the solar system ","To find aliens in space",""], answer:2),8),
                                 (question(question: "What is the significance of the cosmic microwave background radiation?", options: ["It warms up the universe like a giant space heater","It provides evidence for the existence of space aliens","It provides evidence for the Big Bang and helps scientists understand the early stages of the universe ",""], answer:3),8),
                                 (question(question: "What is the Oort Cloud?", options: ["A giant cloud of ice cream in space","A hypothetical region in the outer solar system that is believed to be the source of long-period comets ","The Oort Cloud is a type of alien space station",""], answer:2),8),
                                 (question(question: "What is the role of telescopes in studying the universe?", options: ["To spy on space neighbors","Telescopes help scientists observe and study distant objects in space such as stars galaxies and planets ","Telescopes are used to make giant space sandwiches",""], answer:2),8),
                                 (question(question: "What is a wormhole?", options: ["A hole where worms live in space","A theoretical shortcut through spacetime that could potentially connect two distant points ","A type of alien spaceship",""], answer:2),8),
                                 (question(question: "What is the source of the Sun's energy?", options: ["Space batteries","The Sun's energy comes from nuclear fusion where hydrogen atoms combine to form helium and release a tremendous amount of energy ","The Sun's energy comes from a giant space generator",""], answer:2),9),
                                 (question(question: "What is a satellite?", options: ["A space robot with a pet dog","An object that orbits around a larger object such as a planet or a star ","A type of alien spaceship",""], answer:2),9),
                                 (question(question: "What is the theory of the Big Bounce?", options: ["The theory that the universe likes to jump around like a kangaroo","The theory that the universe could have gone through cycles of expansion and contraction with each cycle starting with a Big Bang ","The theory that space is made of giant rubber bands",""], answer:2),9),
                                 (question(question: "What is a redshift?", options: ["The color of space candy","The change in frequency or wavelength of waves such as light due to the relative motion between the source and the observer ","The sound made by space aliens",""], answer:2),9),
                                 (question(question: "What is a white dwarf?", options: ["A type of star that only shines in the daytime","The remnant core of a small or medium-sized star that has exhausted its nuclear fuel ","A type of space cloud",""], answer:2),9),
                                 (question(question: "What is a supernova remnant?", options: ["The remains of a magical star","The expanding cloud of debris left behind after a supernova explosion ","A type of alien spaceship",""], answer:2),10),
                                 (question(question: "What is the theory of the Steady State?", options: ["The theory that the universe is always calm and peaceful","The theory that the universe has always existed in a constant state without a beginning or an end ","The theory that everything in space is made of metal",""], answer:2),10),
                                 (question(question: "What is a cosmic ray?", options: ["A type of space candy","A high-energy particle that travels through space at nearly the speed of light ","A space alien's favorite mode of transportation",""], answer:2),10),
                                 (question(question: "What is a magnetar?", options: ["A space magnet used for picking up metal objects","A type of neutron star with an extremely strong magnetic field ","A type of alien spaceship",""], answer:2),10),
                                 (question(question: "What is the significance of the Higgs boson?", options: ["The Higgs boson is a particle that likes to party in space","The Higgs boson is a particle that helps give other particles mass and is an important discovery in understanding the fundamental building blocks of the universe ","The Higgs boson is a type of alien space treasure",""], answer:2),10)],
                    ...
                    "Draco":[(question(question: " What is the name of our galaxy?", options: [" The Sunflower Galaxy"," The Milky Way"," The Andromeda Galaxy",""], answer:2),1),
                             ...
                             (question(question: " How old is the Milky Way galaxy?", options: [" About 10000 years"," About 4.5 billion years"," About 13.6 billion years",""], answer:3),2),
                             (question(question: " What is the center of the Milky Way galaxy called?", options: [" The Central Core"," The Galactic Center"," The Celestial Hub",""], answer:2),2),
                             (question(question: " What are the different parts of the Milky Way galaxy called?", options: [" Disk Bulge and Sphere"," Disk Bulge and Halo"," Disk Ball and Crown",""], answer:2),2),
                             (question(question: " Which galaxy is closest to the Milky Way?", options: [" The Andromeda Galaxy"," The Triangulum Galaxy"," The Whirlpool Galaxy",""], answer:3),2),
                             (question(question: " How fast does the Earth orbit around the center of the Milky Way?", options: [" 100 kilometers per second"," Approximately 220 kilometers per second"," 500 kilometers per second",""], answer:2),3),
                             (question(question: " What is the Milky Way made up of?", options: [" Stars and Clouds"," Stars gas dust and dark matter"," Stars and Water",""], answer:2),3),
                             (question(question: " How many arms does the Milky Way have?", options: [" Two major arms"," Three major arms"," Four major arms",""], answer:3),3),
                             (question(question: " What is the name of the largest star in the Milky Way?", options: [" Alpha Centauri"," UY Scuti"," Betelgeuse",""], answer:2),3),
                             (question(question: " What causes the Milky Way to appear as a band of light in the sky?", options: [" Moonlight reflection"," The combined light of countless stars"," Space fireworks",""], answer:2),4),
                             (question(question: " Can we see the entire Milky Way from Earth?", options: [" Yes"," No"," Sometimes",""], answer:2),4),
                             (question(question: " What is the approximate size of the Milky Way?", options: [" About 1000 light-years in diameter"," About 10000 light-years in diameter"," About 100000 light-years in diameter",""], answer:3),4),
                             (question(question: " How long does it take for the Sun to complete one orbit around the Milky Way?", options: [" 100 million years"," Approximately 225-250 million years"," 1 billion years",""], answer:2),4),
                             (question(question: " What is the name of the force that holds the Milky Way together?", options: [" Electricity"," Gravity"," Magnetism",""], answer:2),5),
                             (question(question: " What are some other galaxies found in the Local Group along with the Milky Way?", options: [" The Triangulum Galaxy and The Whirlpool Galaxy"," The Andromeda Galaxy and The Triangulum Galaxy"," The Andromeda Galaxy and The Cartwheel Galaxy",""], answer:3),5),
                             (question(question: " How many planets are there in the Milky Way?", options: ["5","8","10",""], answer:2),5),
                             (question(question: " What is the name of the supermassive black hole at the center of the Milky Way?", options: [" Sagittarius A*"," Black Star"," Galactic Void",""], answer:1),5),
                             (question(question: " How many constellations can be seen from within the Milky Way?", options: [" 10 constellations"," 44 constellations"," 88 constellations",""], answer:3),5),
                             (question(question: " How many satellites or dwarf galaxies orbit the Milky Way?", options: [" About 10 known satellites"," About 30 known satellites"," About 50 known satellites",""], answer:3),5),
                             (question(question: " What is the estimated age of the Milky Way?", options: [" About 5 billion years"," About 13.6 billion years"," About 20 billion years",""], answer:2),5),
                             (question(question: " What is the distance from one end of the Milky Way to the other?", options: [" About 10000 light-years"," Approximately 50000 light-years"," Approximately 100000 light-years",""], answer:3),5),
                             (question(question: " What is the name of the galaxy group that the Milky Way is a part of?", options: [" The Cosmic Cluster"," The Local Group"," The Celestial Assembly",""], answer:2),6),
                             (question(question: " What is the temperature of the core of the Milky Way?", options: [" Around 1000 degrees Celsius"," Around 10 million degrees Celsius"," Around 1 million degrees Celsius",""], answer:2),6),
                             (question(question: " How many arms does our spiral galaxy have?", options: [" One major arm"," Two major arms"," Four major arms",""], answer:3),6),
                             (question(question: " What is the name of the satellite that has been studying the Milky Way since 2009?", options: [" The Hubble Space Telescope"," The Fermi Gamma-ray Space Telescope"," The Voyager Spacecraft",""], answer:2),6),
                             (question(question: " What is the primary source of light in the Milky Way?", options: [" The Moon"," Stars"," Planets",""], answer:2),7),
                             (question(question: " What is the name of the satellite that took the most detailed image of the Milky Way in 2006?", options: [" The Kepler Space Telescope"," The Spitzer Space Telescope"," The James Webb Space Telescope",""], answer:2),7),
                             (question(question: " What is the diameter of the Milky Way's disk?", options: [" About 10000 light-years"," About 50000 light-years"," Around 100000 light-years",""], answer:3),7),
                             (question(question: " How many stars are estimated to be in the Milky Way?", options: [" About 1 billion stars"," About 100 billion to 400 billion stars"," About 1 trillion stars",""], answer:2),7),
                             (question(question: " What is the approximate age of the Milky Way?", options: [" About 5 billion years"," About 13.6 billion years"," About 20 billion years",""], answer:2),8),
                             (question(question: " What is the Milky Way's closest neighboring galaxy?", options: [" The Andromeda Galaxy"," The Triangulum Galaxy"," The Whirlpool Galaxy",""], answer:3),8),
                             (question(question: " What is the name of the supermassive black hole at the center of the Milky Way?", options: [" Sagittarius A*"," Black Star"," Galactic Void",""], answer:1),8),
                             (question(question: " What causes the Milky Way to appear as a band of light in the night sky?", options: [" Moonlight reflection"," The combined light of countless stars"," Space fireworks",""], answer:2),8),
                             (question(question: " How long does it take for our solar system to orbit around the center of the Milky Way?", options: [" 100 million years"," Approximately 225-250 million years"," 1 billion years",""], answer:2),9),
                             (question(question: " How many arms does the Milky Way galaxy have?", options: [" Two major arms"," Three major arms"," Four major arms",""], answer:3),9),
                             (question(question: " What is the estimated number of planets in the Milky Way?", options: [" About 1000 planets"," About 1 million planets"," About billions of planets",""], answer:3),9),
                             (question(question: " What is the center of the Milky Way called?", options: [" The Central Core"," The Galactic Center"," The Celestial Hub",""], answer:2),9),
                             (question(question: " What is the shape of the Milky Way galaxy?", options: [" Square"," Spiral"," Triangle",""], answer:2),10),
                             (question(question: " What is the primary source of energy for stars in the Milky Way?", options: [" Electricity"," Nuclear fusion"," Solar power",""], answer:2),10),
                             (question(question: " What is the approximate size of the Milky Way?", options: [" About 1000 light-years in diameter"," About 10000 light-years in diameter"," About 100000 light-years in diameter",""], answer:3),10),
                             (question(question: " What is the name of the force that holds the Milky Way together?", options: [" Electricity"," Gravity"," Magnetism",""], answer:2),10),
                             (question(question: " Can we see the entire Milky Way from Earth?", options: [" Yes"," No"," Sometimes",""], answer:2),11),
                             (question(question: " What are some other galaxies in the Local Group besides the Milky Way?", options: [" The Triangulum Galaxy and The Whirlpool Galaxy"," The Andromeda Galaxy and The Triangulum Galaxy"," The Andromeda Galaxy and The Cartwheel Galaxy",""], answer:3),11),
                             (question(question: " What is the average distance between stars in the Milky Way?", options: [" Several kilometers"," Several light-years"," Several million light-years",""], answer:2),11),
                             (question(question: " What is the name of the largest star discovered in the Milky Way?", options: [" Alpha Centauri"," UY Scuti"," Betelgeuse",""], answer:2),11),
                             (question(question: " What is the estimated number of stars in the Milky Way?", options: [" About 1 billion stars"," About 100 billion to 400 billion stars"," About 1 trillion stars",""], answer:2),12),
                             (question(question: " How many constellations are there in the Milky Way?", options: [" 10 constellations"," 44 constellations"," 88 constellations",""], answer:3),12)],
                    ...
                    "Canis Major":[(question(question: "What is a dwarf planet?", options: ["A small star","A small celestial body that orbits the Moon","A small celestial body that orbits the Sun but is not large enough to be considered a planet",""], answer:3),1),
                                   ...
                                   (question(question: "What are meteors?", options: ["Planets","Small rocks or debris from space that burn up in Earth's atmosphere"," creating bright streaks in the sky","Shooting stars"], answer:4),2),
                                   (question(question: "What is the proper name for a shooting star?", options: ["Meteorite","Meteor","Comet",""], answer:3),2),
                                   (question(question: "When a meteoroid survives its journey through the Earth's atmosphere and hits the ground what is it called? what is it called?", options: ["Meteorite","Meteor","Cometoid",""], answer:3),2),
                                   (question(question: "What is a comet?", options: ["A small icy object in space that leaves a bright trail of gas and dust behind it as it gets closer to the Sun","A type of asteroid","A distant star",""], answer:3),3),
                                   (question(question: "What is the tail of a comet made of?", options: ["Stars","Dust and rocks","Gas and dust particles reflecting sunlight",""], answer:3),3),
                                   (question(question: "Which famous comet orbits the Sun every 76 years and was last seen in 1986?", options: ["Comet Hale-Bopp","Comet Halley","Comet ISON",""], answer:3),3),
                                   (question(question: "What is a moon?", options: ["A bright light in the night sky","A natural satellite that orbits around a planet","Shooting star",""], answer:3),4),
                                   (question(question: "How many moons does Earth have?", options: ["Two","One","Five",""], answer:3),4),
                                   (question(question: "Which planet has the most moons in our solar system?", options: ["Mars","Saturn","Neptune",""], answer:3),4),
                                   (question(question: "What is the name of Saturn's largest moon?", options: ["Europa","Titan","Io",""], answer:3),5),
                                   (question(question: "Which moon in our solar system is known for its active volcanoes and is one of Jupiter's moons?", options: ["Titan","Io","Enceladus",""], answer:3),5),
                                   (question(question: "What is the name of Mars' two small moons?", options: ["Phobos and Deimos","Ganymede and Callisto","Triton and Charon",""], answer:3),5),
                                   (question(question: "Which moon is the largest in our solar system and belongs to Jupiter?", options: ["Triton","Ganymede","Titan",""], answer:3),6),
                                   (question(question: "What is the name of the spacecraft that visited Pluto and its moons in 2015?", options: ["Voyager 1","New Horizons","Cassini",""], answer:3),6),
                                   (question(question: "Which planet has a famous ring system around it?", options: ["Mars","Saturn","Uranus",""], answer:3),6),
                                   (question(question: "What are Saturn's rings made of?", options: ["Water","Ice and dust particles","Rocks",""], answer:3),7),
                                   (question(question: "What are meteor showers?", options: ["Meteoroids colliding in space","Events when many meteors appear in the sky in a short period","Comets passing close to Earth",""], answer:3),7),
                                   (question(question: "Why do meteor showers happen?", options: ["The Earth's atmosphere reflects light from the Sun","They occur when Earth passes through the debris left by comets","Meteoroids escape from the Moon",""], answer:3),7),
                                   (question(question: "What is the name of the most famous meteor shower that happens in August?", options: ["Perseids","Leonids","Geminids",""], answer:3),8),
                                   (question(question: "What is the largest known meteorite to have hit Earth?", options: ["Gibeon (Namibia)","Hoba (Namibia) at around 66 tons","Campo del Cielo (Argentina)",""], answer:3),8),
                                   (question(question: "How big can a meteor be before it is called an asteroid?", options: ["About the size of a house","Generally asteroids are larger than about 10 meters (33 feet)","The size of a basketball",""], answer:3),8),
                                   (question(question: "What is the name of the mission that landed a rover named Perseverance on Mars to search for signs of past life?", options: ["Mars 2020","Mars Pathfinder","Viking 1",""], answer:3),9),
                                   (question(question: "How long does it take for Halley's Comet to complete one orbit around the Sun?", options: ["50 years","76 years","100 years",""], answer:3),9),
                                   (question(question: "Which spacecraft flew by Pluto and its moons", options: [" providing us with detailed images of these distant worlds?","Voyager 1","New Horizons",""], answer:3),9),
                                   (question(question: "Which planet is famous for its beautiful rings which are made of ice and dust particles?", options: ["Mars","Saturn","Uranus",""], answer:3),10),
                                   (question(question: "What is the name of Mars' largest moon?", options: ["Phobos","Deimos","Ganymede",""], answer:3),10),
                                   (question(question: "Which moon in our solar system is known for its colorful striped appearance and has a thick atmosphere?", options: ["Titan","Triton","Saturn's moon Titan",""], answer:3),10),
                                   (question(question: "Which planet has a big red spot which is actually a massive storm that has been raging for hundreds of years?", options: ["Jupiter","Saturn","Neptune",""], answer:3),11),
                                   (question(question: "Which moon is the largest in our solar system and belongs to Jupiter?", options: ["Titan","Ganymede","Callisto",""], answer:3),11),
                                   (question(question: "What are the small rocky pieces that burn up in Earth's atmosphere creating bright streaks in the sky?", options: ["Asteroids","Meteors","Comets",""], answer:3),11),
                                   (question(question: "Which moon in our solar system is known for its icy surface and geysers that shoot water into space?", options: ["Ganymede","Enceladus","Triton",""], answer:3),12),
                                   (question(question: "What is the name of the most famous dwarf planet in our solar system which used to be considered the ninth planet?", options: ["Ceres","Pluto","Eris",""], answer:3),12),
                                   (question(question: "What is the name of the spacecraft that landed a rover named Perseverance on Mars to search for signs of past life?", options: ["Mars 2020","Mars Pathfinder","Viking 1",""], answer:3),12),
                                   (question(question: "Which planet has a famous Great Red Spot which is a massive storm that has been raging for hundreds of years?", options: ["Jupiter","Saturn","Neptune",""], answer:3),13),
                                   (question(question: "What is the name of the mission that landed a rover on Mars to look for signs of past life and collect samples for a future return to Earth?", options: ["Mars 2020","Mars Pathfinder","Viking 1",""], answer:3),13),
                                   (question(question: "Which planet has the most moons in our solar system?", options: ["Mars","Jupiter","Saturn",""], answer:3),13),
                                   (question(question: "What is the name of Saturn's largest moon which is bigger than the planet Mercury?", options: ["Titan","Ganymede","",""], answer:1),13)]]
